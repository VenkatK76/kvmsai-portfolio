...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description:
        "A fitness tracking application that allows users to monitor their workouts, nutrition, and health metrics.",
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div
              key={project.id}
              className="bg-gray-50 dark:bg-navy-light rounded-lg overflow-hidden shadow-sm transition-all duration-300 hover:shadow-md"
            >
